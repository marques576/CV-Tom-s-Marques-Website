		...
		function(buffer) {
			...
			$('#info')
				.fadeOut('normal', function() {
					$(this).html('<div id="artist"><a href="index.html" class="name">The xx</a><br /><a href="dshop/dshop.html"class="song">VCR</a><br /></div><div><img src="data/xx.png" width="58" height="58" /></div>');
				})
				.fadeIn();
